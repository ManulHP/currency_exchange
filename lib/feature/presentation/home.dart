...
import 'package:currency_exchange/feature/presentation/resuable/error_snack_bar.dart';
                      ...
                      BlocConsumer<CurrencyBloc, CurrencyState>(
                        listener: (context, exchange) {
                          if (exchange.status == CurrencyStatus.loading) {
                            ...
                            // event to save the data locally
                            ...
                            CustomSnackBar().showSnackBar(context,
                                      ...
                                      msg: exchange.errorMessage ?? "Something went wrong",
                              );
                          }
                        },
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      // event to remove the locally stored data
